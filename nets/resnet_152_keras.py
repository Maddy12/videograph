...
# save the model weights in the following directories
WEIGHTS_PATH = Pth('/Keras_Models/resnet_152/resnet152_weights_tf_dim_ordering_tf_kernels.h5')
WEIGHTS_PATH_NO_TOP = Pth('Keras_Models/resnet_152/resnet152_weights_tf_dim_ordering_tf_kernels_no_top.h5')
